...
export default function Header() {
  ...
  return (
    <>
      <header className="fixed top-6 left-0 right-0 z-50 mx-auto w-full max-w-[97%] px-4 md:px-6 flex items-center justify-between rounded-full border border-white/10 bg-white/5 py-4 shadow-lg shadow-black/10 backdrop-blur-xl transition-all duration-300">
        <Link
          href="/"
