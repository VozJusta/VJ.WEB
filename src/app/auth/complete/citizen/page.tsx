...
import { CompleteRegisterCitizenForm } from "@/features/auth/complete-register";

export const metadata: Metadata = {
  title: "Completar Cadastro | VozJusta",
  description: "Finalize seu cadastro de cidadão na VozJusta.",
};
...
export default function CompleteRegisterCitizenPage() {
  return (
