...
export const itemWrapper =
  "group relative flex items-center gap-4 w-full px-5 py-4 rounded-xl bg-[#161c26] border border-[#1B2233] transition-all duration-200 hover:bg-[#1a2233] hover:border-[#1B2233] hover:shadow-[0_4px_24px_rgba(0,0,0,0.25)]";
...
export const menuDropdownClass =
  "absolute right-0 top-full mt-1.5 z-20 min-w-[160px] rounded-xl bg-[#1e2735] border border-[#1B2233] shadow-[0_8px_32px_rgba(0,0,0,0.45)] overflow-hidden animate-[file-enter_0.18s_ease-out]";
