...
function SectionDivider() {
  return <li aria-hidden><hr className="border-white/06 mx-4" /></li>;
}
...
export function SettingsFeature() {
  ...
  return (
    <div className="flex flex-col items-center gap-5 w-full max-w-2xl mx-auto px-4 py-6 md:px-0 md:py-8">
      ...
      {/* Main settings card */}
      <section
        className="w-full rounded-2xl bg-[#111c30] border border-white/06 overflow-hidden"
      ...
      >
        ...
        <hr className="border-white/06 mx-4 mt-1" />
      ...
      <Link
        href="/suporte"
        className="w-full flex items-center gap-4 px-5 py-4 rounded-2xl bg-[#111c30] border border-white/06 hover:border-white/12 hover:bg-[#152036] transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2585F4]"
      ...
      >
        ...
        <div className="flex flex-col flex-1 min-w-0">
          <span className="text-sm font-semibold text-white">Falar com suporte</span>
          <span className="text-xs text-white/45">Atendimento 24/7 disponível</span>
        </div>
