...
export const citizenPlans: Plan[] = [
  {
    ...
    ctaHref: "/signup/cidadao-consciente",
    variant: "dark",
    audience: "citizen",
  },
  {
    ...
    ctaHref: "/checkout/voz-protegida",
    variant: "light",
    recommended: true,
    audience: "citizen",
  },
...
export const lawyerPlans: Plan[] = [
  {
    ...
    ctaHref: "/signup/advogado-junior",
    variant: "dark",
    audience: "lawyer",
  },
  {
    ...
    ctaText: "Assinar Pro",
    ctaHref: "/checkout/escritorio-digital",
    variant: "light",
    recommended: true,
    audience: "lawyer",
  },
  {
    ...
    ctaHref: "/checkout/master-juridico",
    variant: "dark",
    audience: "lawyer",
  },
];