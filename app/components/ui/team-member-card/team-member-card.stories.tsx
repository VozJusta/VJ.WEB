...
export const LongDescription: Story = {
  args: {
    ...
    description:
      "Product Manager experiente com histórico de lançamentos bem-sucedidos em startups e empresas de tecnologia. Focado em criar produtos que realmente resolvem problemas dos usuários.",
  },
};
