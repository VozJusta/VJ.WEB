...
export const WithInitials: Story = {
  args: {
    quote: 'O VozJusta me deu segurança jurídica e clareza nos contratos. Antes eu assinava sem entender nada.',
    authorName: 'João P.',
...
export const WithAvatar: Story = {
  args: {
    quote: 'Como advogado, recomendo o VozJusta para meus clientes MEI. É uma ferramenta essencial para proteção jurídica.',
...
export const WithCustomInitials: Story = {
  args: {
    quote: 'Finalmente consigo entender meus contratos sem precisar pagar caro por consultas jurídicas.',
