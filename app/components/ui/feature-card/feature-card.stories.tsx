...
import { FeatureCardVariant, FeatureCardAlignment, FeatureCardSize } from './feature-card.types';
...
const meta = {
  ...
  argTypes: {
    ...
    variant: {
      control: 'select',
      options: ['default', 'elevated', 'flat', 'outlined', 'gradient'] as FeatureCardVariant[],
