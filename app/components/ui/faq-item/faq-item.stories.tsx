...
export const LongContent: Story = {
  args: {
    ...
    answer: 'We accept all major credit cards including Visa, Mastercard, American Express, and Discover. We also accept PayPal, Apple Pay, Google Pay, and bank transfers for larger orders. For enterprise customers, we can arrange invoice-based billing with net-30 payment terms.',
    defaultOpen: false,
  },
};
